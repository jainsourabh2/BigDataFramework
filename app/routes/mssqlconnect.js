...
module.exports = function (app, express) {
	...
	api.post('/mssqlcreatesqoopjob', function(req,res) {
		...
		let sqoop_job_create = "sqoop job --create "+sqoopJobName+" -- import --driver com.microsoft.sqlserver.jdbc.SQLServerDriver --username "+username+" --password "+password+" --table "+dbTable+" --m 1 --target-dir /user/mapr/employee/ --append --connect "+connectionString;
